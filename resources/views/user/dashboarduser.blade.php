    ...
    <div class="d-flex">
        <div id="sidebar" class="text-white p-3">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link text-white active" href="/dashboarduser">
...
<div class="row">
    ...
    <div class="col-lg-3 col-md-6 text-center mb-4">
        <div class="feature-img-container">
            ...
            <div class="feature-text">
                <h5>Fitur 2: Pelacakan Arsip</h5>
                <p>Melacak lokasi disimpannya arsip secara real-time</p>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 text-center mb-4">
    ...
    <div class="col-lg-3 col-md-6 text-center mb-4">
        <div class="feature-img-container">
            ...
            <div class="feature-text">
                <h5>Fitur 4: Contact Admin</h5>
                <p>Hubungi admin terkait masalah atau layanan tentang sistem</p>
            </div>
        </div>
    </div>
</div>
