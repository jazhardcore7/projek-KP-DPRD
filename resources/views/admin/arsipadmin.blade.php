...
<head>
    ...
    <style>
        ...
        .table tbody tr td .btn-container {
            display: grid;
    ...
    <div class="d-flex">
        <div id="sidebar" class="text-white p-3">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active" href="/arsipadm">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-container">
                                        <a href="{{ route('editarsip', ['arsip' => $show->nomor]) }}" class="btn btn-sm btn-edit">Edit</a>
                                        <form action="{{ route('deletearsip', ['arsip' => $show->nomor]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this user?');" class="ml-2">
                                            @csrf
                                            @method('DELETE')
